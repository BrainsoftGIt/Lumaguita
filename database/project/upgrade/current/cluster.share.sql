...
with __shares( share_regclass, share_insert, share_update,  share_checker ) as(
  ...
  union all values ( 'tweeks.guia'::regclass, true, true, null::regprocedure )
  union all values ( 'tweeks.custoguia'::regclass, true, true, null::regprocedure )
