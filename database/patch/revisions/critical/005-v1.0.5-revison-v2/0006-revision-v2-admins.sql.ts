...
block( module, { identifier: "maguita_revision_v2_admins-source", flags:[  "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_admins-functions", flags:[  ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_move-branch-to-cluster", flags:[ "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_load-configs", flags:[  ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_auth", flags:[ "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_auth_domain", flags:[ "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "maguita_revision_v2_auth", flags:[  ],
// language=PostgreSQL
} ).sql`
