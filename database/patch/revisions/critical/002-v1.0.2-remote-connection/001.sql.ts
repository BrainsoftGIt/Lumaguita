...
let blockInstance = block( module, { identifier: "cluster-remote-grants", flags:[ "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "cluster.remote-change-001", flags:[ "@unique" ],
// language=PostgreSQL
} ).sql`
...
block( module, { identifier: "remote-functions", flags:[  ],
// language=PostgreSQL
} ).sql`
