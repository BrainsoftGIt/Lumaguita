...
(0, updater_1.block)(module, { identifier: "lumaguita_path_01", flags: ["@unique"] }).sql `
    drop table if exists tweeks.stock;
    drop view if exists tweeks.stock;
`;
(0, updater_1.block)(module, { identifier: "lumaguita_path_02", flags: ["@unique"] }).sql `
create or replace view tweeks.stock as
  ...
  select * from __stock; `;
(0, updater_1.block)(module, { identifier: "lumaguita_path_03", flags: [] }).sql `
...
$$;
`;
(0, updater_1.block)(module, { identifier: "lumaguita_path_04", flags: [] }).sql `
...
`;
//# sourceMappingURL=0001-migration-maguita-to-luma-path.sql.js.map