...
(0, updater_1.block)(module, { identifier: "classname-map", flags: ["@unique"] }).sql `
...
`;
(0, updater_1.block)(module, { identifier: "classname-map-pull", flags: ["@unique"] }).sql `
...
$$;
`;
(0, updater_1.block)(module, { identifier: "___override_auth_funct_autenticacao:classmap", flags: [] }).sql `
...
$$;
`;
//# sourceMappingURL=001-claname-map.sql.js.map