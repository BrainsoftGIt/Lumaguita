  ...
  loadMenus(){
      $.ajax({
          ...
          success(e) {
            ...
            menuAcessos.html(`<li data-position="-1" class="tgl flex v-ct active" link="../includes/home.html" title="Home">
            ...
            colaborador_logado_armazens.empty();
              ...
              let menusSemFaturasGuias = menus.filter(function (value) {
                    ...
                    return value.menu_codigo !== "maguita.proforma"
                          ...
                          && value.menu_codigo !== "maguita.geralfaturas"
              ...
              menusSemFaturasGuias.forEach((meSFQ) => {
                  ...
                  menuAcessos.append(`<li data-position="${meSFQ.menu_position}" class="tgl flex v-ct" link="${meSFQ.menu_link}" title="${meSFQ.menu_nome}">
                                            ${meSFQ.menu_icon}
                ...
                acesso.menusFaturasGuias.forEach((meFQ) =>{
                    ...
                    if((meFQ.menu_codigo === "maguita.fatura" || meFQ.menu_codigo === "maguita.proforma" || meFQ.menu_codigo === "maguita.notacredito" || meFQ.menu_codigo === "maguita.geralfaturas")){
            ...
            if(acesso.showConfig){
                menuAcessos.append(`<li data-position="1000" class="tgl flex v-ct" link="../includes/systemConfig.html" title="Configurações do sistema">  
              ...
              menuAcessos.find("li").eq(0).click();
