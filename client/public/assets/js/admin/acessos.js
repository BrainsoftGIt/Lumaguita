  ...
  loadMenus(){
      $.ajax({
          ...
          success({TAG, ...e}) {
            ...
            menuAcessos.html(`<li data-position="-100" class="tgl flex v-ct active" link="../includes/home" title="Home" code="main">
            ...
            if(acesso.showConfig){
                menuAcessos.append(`<li data-position="1000" class="tgl flex v-ct" link="../includes/systemConfig" title="Configurações do sistema" code="sys">  
