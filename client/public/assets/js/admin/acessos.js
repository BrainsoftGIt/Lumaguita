          ...
          success(e) {
            ...
            colaborador_logado_armazens.empty();
              ...
              menusSemFaturasGuias.forEach((meSFQ) => {
                  ...
                  menuAcessos.append(`<li class="tgl flex v-ct" link="${meSFQ.menu_link}" title="${meSFQ.menu_nome}">
                                            ${meSFQ.menu_icon}
                ...
                acesso.menusFaturasGuias.forEach((meFQ) =>{
                    ...
                    if((meFQ.menu_codigo === "maguita.fatura" || meFQ.menu_codigo === "maguita.proforma" || meFQ.menu_codigo === "maguita.notacredito" || meFQ.menu_codigo === "maguita.geralfaturas")){
                        ...
                        if(menuAcessos.find("li[tipo=guia]").length === 0 && (meFQ.menu_codigo === "maguita.entrada.artigos" || meFQ.menu_codigo === "maguita.saida.artigos")){
                            menuAcessos.append(`<li class="tgl flex v-ct" link="${meFQ.menu_link}" title="Guias" tipo="guia" code="${meFQ.menu_codigo}">
                                            ${meFQ.menu_icon}
                                        <span>Guias</span>
                                    </li>`);
                        }
            ...
            if(acesso.showConfig){
                menuAcessos.append(`<li class="tgl flex v-ct" link="../includes/systemConfig.html" title="Configurações do sistema">  
