        ...
        $.ajax({
            ...
            success({cambio_ativos}) {
                ...
                cambio_ativos.forEach(({data : {cambio_taxa, currency_id, currency_code}}) =>{
                    factura_moeda.append(`<li data-currency_code="${currency_code}" data-cambio_taxa="${cambio_taxa}" data-currency_id="${currency_id}">${currency_code} (${cambio_taxa.formatter()})</li>`);
                });
